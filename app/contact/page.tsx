      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all text-center">
              <Mail className="w-12 h-12 mx-auto mb-4 text-blue-400" />
              <h3 className="text-xl font-bold mb-2">Email Us</h3>
              <p className="text-gray-400 text-sm">contact@xcombinator.com</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all text-center">
              ...
              <p className="text-gray-400 text-sm">@xCombinator</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all text-center">
              <Send className="w-12 h-12 mx-auto mb-4 text-blue-400" />
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all text-center">
              ...
              <p className="text-gray-400 text-sm">Chat with the team</p>
            </div>
          </a>
        </div>
